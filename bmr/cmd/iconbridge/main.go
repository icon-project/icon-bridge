...
import (
	...
	"github.com/icon-project/icon-bridge/bmr/cmd/iconbridge/relay"
	"github.com/icon-project/icon-bridge/bmr/cmd/iconbridge/stat"
	"github.com/icon-project/icon-bridge/bmr/common/config"
	"github.com/icon-project/icon-bridge/bmr/common/log"

	_ "github.com/icon-project/icon-bridge/bmr/cmd/iconbridge/chain/bsc"
	_ "github.com/icon-project/icon-bridge/bmr/cmd/iconbridge/chain/hmny"
	_ "github.com/icon-project/icon-bridge/bmr/cmd/iconbridge/chain/icon"
)

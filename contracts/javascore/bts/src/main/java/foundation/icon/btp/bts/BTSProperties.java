...
public class BTSProperties {
    public static final BTSProperties DEFAULT;

    static {
        DEFAULT = new BTSProperties();
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("BTSProperties{");
    ...
    public static void writeObject(ObjectWriter writer, BTSProperties obj) {
        obj.writeObject(writer);
    }

    public static BTSProperties readObject(ObjectReader reader) {
        BTSProperties obj = new BTSProperties();
        reader.beginList();
    ...
    public static BTSProperties fromBytes(byte[] bytes) {
        ObjectReader reader = Context.newByteArrayObjectReader("RLPn", bytes);
        return BTSProperties.readObject(reader);
    }

    public byte[] toBytes() {
        ByteArrayObjectWriter writer = Context.newByteArrayObjectWriter("RLPn");
        BTSProperties.writeObject(writer, this);

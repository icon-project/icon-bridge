...
contract("NativeCoinBSH contracts - After Upgrading Contract", (accounts) => {
    describe("PRA BTSCore Query and Management - After Upgrading Contract", () => {
        let bts_peripheryV1, bts_peripheryV2, bts_coreV1, bts_coreV2;
        let _native = "PARA";
        let _fee = 10;
        ...
        before(async () => {
            ...
            bts_peripheryV1 = await deployProxy(BTSPeripheryV1, [
                bmc.address,
                bts_coreV1.address,
                service,
            ]);
            encode_msg = await EncodeMsg.new();
            await bts_coreV1.updateBTSPeriphery(bts_peripheryV1.address);
            bts_peripheryV2 = await upgradeProxy(
        ...
        it("Scenario 3: Contract’s owner registers an existed coin", async () => {
            let _name = "ICON";
            await truffleAssert.reverts(
                bts_coreV2.register.call(_name),
                "ExistCoin"
            );
        });

        it("Scenario 4: Contract’s owner to update BTSPeriphery contract", async () => {
            await bts_coreV2.updateBTSPeriphery(bts_peripheryV2.address);
        });

        it("Scenario 5: Non-ownership role client updates BTSPeriphery contract", async () => {
            await truffleAssert.reverts(
                bts_coreV2.updateBTSPeriphery.call(bts_peripheryV2.address, {
                    from: accounts[1],
                }),
                "Unauthorized"
            );
        ...
        it("Scenario 6: Contract’s owner updates BTSPeriphery while this contract has pending requests", async () => {
            ...
            await bts_coreV2.transferNativeCoin(_to, {
                from: accounts[0],
                value: 100000000,
            });
            await truffleAssert.reverts(
        ...
        it("Scenario 21: New owner updates BTSPeriphery contract", async () => {
            let newBTSPeriphery = await BTSPeripheryV2.new();
            await bts_coreV2.updateBTSPeriphery(newBTSPeriphery.address, {
                from: accounts[1],
            });
        });
    ...
    describe("As a user, I want to send PRA to ICON blockchain - After Upgrading Contract", () => {
        ...
        let _fee = 10;
        let REPONSE_HANDLE_SERVICE = 2;
        let _uri = "https://github.com/icon-project/icon-bridge/bmr";
        ...
        before(async () => {
            ...
            encode_msg = await EncodeMsg.new();
            await bts_coreV1.updateBTSPeriphery(bts_peripheryV1.address);
            await bmc.addService(service, bts_peripheryV1.address);
            bts_peripheryV2 = await upgradeProxy(
                bts_peripheryV1.address,
                BTSPeripheryV2
            );
        ...
        it("Scenario 1: Transferring native coins to an invalid BTP Address format", async () => {
            ...
            let amount = 600000;
            await truffleAssert.reverts(
                bts_coreV2.transferNativeCoin.call(invalid_destination, {
                    from: accounts[0],
                    value: amount,
                }),
                "revert"
            );
            bts_coin_balance = await bts_coreV2.getBalanceOf(
                bts_coreV2.address,
                _native
            );
            account_balance = await bts_coreV2.getBalanceOf(
                accounts[0],
                _native
            );
            assert(
                web3.utils.BN(bts_coin_balance._usableBalance).toNumber() ===
                    0 &&
                    web3.utils.BN(account_balance._lockedBalance).toNumber() ===
                        0
            );
        });
        ...
        it("Scenario 2: Transferring zero coin", async () => {
            await truffleAssert.reverts(
                bts_coreV2.transferNativeCoin.call(_to, {
                    from: accounts[0],
                    value: 0,
                }),
                "revert"
        ...
        it("Scenario 5: Account client transfers a valid native coin to a side chain", async () => {
            let amount = 600000;
            let account_balanceBefore = await bts_coreV2.getBalanceOf(
                accounts[0],
                _native
            );
            let tx = await bts_coreV2.transferNativeCoin(_to, {
                from: accounts[0],
                value: amount,
            });
            let account_balanceAfter = await bts_coreV2.getBalanceOf(
                accounts[0],
                _native
            );
            let bts_coin_balance = await bts_coreV2.getBalanceOf(
                bts_coreV2.address,
                _native
            );
            let chargedFee = Math.floor(amount / 1000) + _fixed_fee;

            const transferEvents = await bts_peripheryV2.getPastEvents(
                "TransferStart",
        ...
        it("Scenario 6: BTSPeriphery receives a successful response of a recent request", async () => {
            ...
            let fees = await bts_coreV2.getAccumulatedFees();
        ...
        it("Scenario 7: BTSPeriphery receives an error response of a recent request", async () => {
            ...
            let bts_coin_balance_before = await bts_coreV2.getBalanceOf(
                bts_coreV2.address,
                _native
            );
            let _msg = await encode_msg.encodeResponseMsg(
            ...
            let bts_coin_balance_after = await bts_coreV2.getBalanceOf(
                bts_coreV2.address,
                _native
            );
        ...
        it("Scenario 8: Non-refundable contract transfers a valid native coin to a side chain", async () => {
            ...
            let contract_balanceBefore = await bts_coreV2.getBalanceOf(
            ...
            let tx = await nonrefundable.transfer(
                bts_coreV2.address,
                _to,
                amount
            );
            let contract_balanceAfter = await bts_coreV2.getBalanceOf(
                nonrefundable.address,
                _native
            );
            let bts_coin_balance_after = await bts_coreV2.getBalanceOf(
            ...
            assert(
                web3.utils
                    .BN(contract_balanceBefore._usableBalance)
                    .toNumber() ===
                    web3.utils
                        .BN(contract_balanceAfter._usableBalance)
                        .toNumber() +
                        amount &&
                    web3.utils
        ...
        it(`Scenario 9: BTSPeriphery receives an error response of a recent request and fails to refund coins back to Non-refundable contract`, async () => {
            ...
            assert.equal(
                web3.utils
                    .BN(contract_balanceAfter._refundableBalance)
                    .toNumber(),
                amount - chargedFee
            );
            assert.equal(
        ...
        it("Scenario 10: Refundable contract transfers a valid native coin to a side chain", async () => {
            ...
            let tx = await refundable.transfer(bts_coreV2.address, _to, amount);
            let contract_balanceAfter = await bts_coreV2.getBalanceOf(
                refundable.address,
                _native
            );
    ...
    describe("As a user, I want to send ERC1155_ICX to ICON blockchain - After Upgrading Contract", () => {
        ...
        it("Scenario 1: User has not yet set approval for token being transferred out by Operator", async () => {
            ...
            let balanceAfter = await bts_coreV2.getBalanceOf(
                holder.address,
                _name
            );
        ...
        it(`Scenario 2: User has set approval, but user's balance has insufficient amount`, async () => {
            ...
            await holder.setApprove(coinId, bts_coreV2.address, _value);
            await truffleAssert.reverts(
                holder.callTransfer.call(_name, _value, _to),
        ...
        it("Scenario 4: User transfers Tokens to an invalid BTP Address format", async () => {
            ...
            await holder.setApprove(coinId, bts_coreV2.address, amount);
            await truffleAssert.reverts(
            ...
            let bts_core_balance = await bts_coreV2.getBalanceOf(
                bts_coreV2.address,
                _name
            );
        ...
        it("Scenario 8: User sends a valid transferring request", async () => {
            ...
            let bts_core_balance_before = await bts_coreV2.getBalanceOf(
                bts_coreV2.address,
                _name
            );
            await holder.setApprove(coinId, bts_coreV2.address, amount);
            ...
            let bts_core_balance_after = await bts_coreV2.getBalanceOf(
                bts_coreV2.address,
                _name
            );
            let chargedFee = Math.floor(amount / 1000) + _fixed_fee;
    ...
    describe.skip("As a user, I want to receive ERC1155_ICX from ICON blockchain - After Upgrading Contract", () => {
        ...
        it(`Scenario 2: Receiving contract does not implement ERC1155Holder / Receiver`, async () => {
            let _value = 1000;
            let balanceBefore = (
                await bts_coreV2.getBalanceOf(notpayable.address, _name)
            )[0];
            let _eventMsg = await encode_msg.encodeResponseBMCMessage(
                btpAddr,
                _bmcICON,
        ...
        it("Scenario 3: BTSPeriphery receives a request of invalid token", async () => {
            ...
            let invalid_coin_id = await bts_coreV2.coinId(_tokenName);
            let balanceBefore = (
                await bts_coreV2.getBalanceOf(notpayable.address, _tokenName)
            )[0];
            let _eventMsg = await encode_msg.encodeResponseBMCMessage(
                btpAddr,
                _bmcICON,
    ...
    describe("BSHs Handle Fee Aggregation - After Upgrading Contract", () => {
        ...
        before(async () => {
            ...
            await bts_coreV2.register(_name2, "", 18);
            await bts_coreV2.register(_name3, "", 18);
            await bts_coreV2.register(_name4, "", 18);
            ...
            await bts_coreV2.transferNativeCoin(_to1, {
                from: accounts[0],
                value: _txAmt,
            });
            ...
            coinId1 = await bts_coreV2.coinId(_name1);
            coinId2 = await bts_coreV2.coinId(_name2);
            coinId3 = await bts_coreV2.coinId(_name3);
            coinId4 = await bts_coreV2.coinId(_name4);
            await holder.setApprove(coinId1, bts_coreV2.address, _txAmt1);
            await holder.setApprove(coinId2, bts_coreV2.address, _txAmt2);
            await holder.setApprove(coinId3, bts_coreV2.address, _txAmt2);
            await holder.setApprove(coinId4, bts_coreV2.address, _txAmt2);
        ...
        it(`Scenario 1: Query 'Aggregation Fee'`, async () => {
            let aggregationFee = await bts_coreV2.getAccumulatedFees();
        ...
        it("Scenario 2: Receiving a FeeGathering request not from BMCService", async () => {
            let _sn3 = 3;
            let FA1Before = await bts_peripheryV2.getAggregationFeeOf(_native); //  state Aggregation Fee of each type of Coins
            let FA2Before = await bts_peripheryV2.getAggregationFeeOf(_name1);
            let FA3Before = await bts_peripheryV2.getAggregationFeeOf(_name2);
            await truffleAssert.reverts(
                bts_peripheryV2.handleFeeGathering.call(_to1, service, {
                    from: accounts[1],
                }),
                "Unauthorized"
            );
            let FA1After = await bts_peripheryV2.getAggregationFeeOf(_native);
            let FA2After = await bts_peripheryV2.getAggregationFeeOf(_name1);
            let FA3After = await bts_peripheryV2.getAggregationFeeOf(_name2);
            let fees = await bts_peripheryV2.getPendingRequest(_sn3); //  get pending Aggregation Fee list
        ...
        it("Scenario 3: Handle GatherFee request from BMCService contract", async () => {
            ...
            let FA2Before = await bts_peripheryV2.getAggregationFeeOf(_name1);
            let FA3Before = await bts_peripheryV2.getAggregationFeeOf(_name2);
            let _bmcService = await encode_msg.encodeBMCService(_to1, [
                service,
            ]);
            let output = await bmc.receiveRequest(
                _bmcICON,
            ...
            const transferEvents = await bts_peripheryV2.getPastEvents(
                "TransferStart",
                { fromBlock: output.receipt.blockNumber, toBlock: "latest" }
            );
            let event = transferEvents[0].returnValues;
            assert.equal(event._from, bts_coreV2.address);
        ...
        it("Scenario 4: Receiving a successful response", async () => {
            let _sn3 = 4;
            let feesBefore = await bts_peripheryV2.getPendingRequest(_sn3);
            let _responseMsg = await encode_msg.encodeResponseMsg(
                REPONSE_HANDLE_SERVICE,
                RC_OK,
                ""
            );
            let tx = await bmc.receiveResponse(
                _net1,
                service,
                _sn3,
                _responseMsg
            );
            let feesAfter = await bts_peripheryV2.getPendingRequest(_sn3);
        ...
        it("Scenario 5: Receiving an error response", async () => {
            ...
            let _amt1 = 2000000;
            let _amt2 = 6000000;
            await holder.setApprove(coinId1, bts_coreV2.address, _amt1);
            await holder.setApprove(coinId2, bts_coreV2.address, _amt2);
            ...
            let FA1Before = await bts_peripheryV2.getAggregationFeeOf(_name1);
            let FA2Before = await bts_peripheryV2.getAggregationFeeOf(_name2);
            ...
            let FA1After = await bts_peripheryV2.getAggregationFeeOf(_name1);
            let FA2After = await bts_peripheryV2.getAggregationFeeOf(_name2);
    ...
    describe("As a user, I want to receive multiple Coins/Tokens from ICON blockchain - After Upgrading Contract", () => {
        ...
        it("Scenario 2: BSHPerphery receives a request of invalid token", async () => {
            ...
            let balance1Before = await bts_coreV2.getBalanceOf(
                holder.address,
                _name1
            );
            let balance2Before = await bts_coreV2.getBalanceOf(
                holder.address,
                _name2
            );
            let balance3Before = await bts_coreV2.getBalanceOf(
                holder.address,
                _invalid_token
            );
            ...
            let balance1After = await bts_coreV2.getBalanceOf(
                holder.address,
                _name1
            );
            let balance2After = await bts_coreV2.getBalanceOf(
                holder.address,
                _name2
            );
            let balance3After = await bts_coreV2.getBalanceOf(
                holder.address,
                _invalid_token
            );
    ...
    describe("As a user, I want to send multiple coins/tokens to ICON blockchain - After Upgrading Contract", () => {
        ...
        before(async () => {
            ...
            await bts_coreV2.register(_coin1, "", 18);
            await bts_coreV2.register(_coin2, "", 18);
            await bts_coreV2.register(_coin3, "", 18);
            await bts_coreV2.transferNativeCoin(
                "btp://1234.iconee/0x12345678",
                { from: accounts[0], value: initAmt }
            );
        ...
        it("Scenario 1: User has not yet set approval for token being transferred out by Operator", async () => {
            ...
            let balanceBefore = await bts_coreV2.getBalanceOfBatch(
                holder.address,
                _query
            );
            await truffleAssert.reverts(
            ...
            let balanceAfter = await bts_coreV2.getBalanceOfBatch(
                holder.address,
                _query
            );
            let bts_core_balance = await bts_coreV2.getBalanceOfBatch(
                bts_coreV2.address,
                _query
            );
        ...
        it(`Scenario 2: User has set approval, but user's balance has insufficient amount`, async () => {
            ...
            coinId1 = await bts_coreV2.coinId(_coin1);
            coinId2 = await bts_coreV2.coinId(_coin2);
            await holder.setApprove(coinId1, bts_coreV2.address, _values[0]);
            await holder.setApprove(coinId2, bts_coreV2.address, _values[1]);
            await truffleAssert.reverts(
                holder.callTransferBatch.call(
                    bts_coreV2.address,
                    _coins,
        ...
        it("Scenario 3: User requests to transfer an invalid Token", async () => {
            ...
            coinId1 = await bts_coreV2.coinId(_coins[0]);
            coinId2 = await bts_coreV2.coinId(_coins[1]);
            await holder.setApprove(coinId1, bts_coreV2.address, _values[0]);
            // await holder.setApprove(coinId2, bts_coreV2.address,_values[1]);
            await truffleAssert.reverts(
                holder.callTransferBatch.call(
        ...
        it("Scenario 8: Account client sends an invalid request of transferBatch", async () => {
            ...
            await truffleAssert.reverts(
                bts_coreV2.transferBatch.call(_coins, _values, _to, {
                    from: accounts[2],
                    value: 600000,
                }),
                "revert"
        ...
        it("Scenario 12: Account client sends a valid transferBatch request", async () => {
            ...
            coinId1 = await bts_coreV2.coinId(_coins[0]);
            coinId2 = await bts_coreV2.coinId(_coins[1]);
            coinId3 = await bts_coreV2.coinId(_coins[2]);
            ...
            await ERC20Tradable1.approve(bts_coreV2.address, _values[0], {
                from: accounts[1],
            });
            await ERC20Tradable2.approve(bts_coreV2.address, _values[1], {
                from: accounts[1],
            });
            await ERC20Tradable3.approve(bts_coreV2.address, _values[2], {
                from: accounts[1],
            });
            let tx = await bts_coreV2.transferBatch(_coins, _values, _to, {
                from: accounts[1],
            });
            let balanceAfter = await bts_coreV2.getBalanceOfBatch(
                accounts[1],
        ...
        it("Scenario 14: Contract client sends a valid transferBatch request", async () => {
            ...
            await holder.setApprove(coinId1, bts_coreV2.address, _values[0]);
            await holder.setApprove(coinId2, bts_coreV2.address, _values[1]);
            await holder.setApprove(coinId3, bts_coreV2.address, _values[2]);
            let tx = await holder.callTransferBatch(
                bts_coreV2.address,
                _coins,
                _values,

...
func VerifyHeader(header *types.Header) error {
...
func VerifyCascadingFields(header *types.Header, parent *types.Header) error {
	number := header.Number.Uint64()
	if number == 0 {
		return nil
	}
...
func VerifySeal(header *types.Header, chainID *big.Int) (ethCommon.Address, error) {
...
func ValidateState(header *types.Header, receipts types.Receipts) error {

...
import (
	...
	erc20 "github.com/icon-project/icon-bridge/cmd/e2etest/chain/hmny/abi/erc20tradable"
	hrc20 "github.com/icon-project/icon-bridge/cmd/e2etest/chain/hmny/abi/hrc20"

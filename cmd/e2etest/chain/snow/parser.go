...
import (
	...
	bmcp "github.com/icon-project/icon-bridge/cmd/e2etest/chain/snow/abi/bmcperiphery"
	btsp "github.com/icon-project/icon-bridge/cmd/e2etest/chain/snow/abi/btsperiphery"

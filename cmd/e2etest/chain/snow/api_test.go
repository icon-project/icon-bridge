...
const (
	...
	TokenGodKey  = ""
	TokenGodAddr = "btp://0x228.snow/"
	GodKey       = ""
	GodAddr      = "btp://0x228.snow/0x70E789D2f5D469eA30e0525DbfDD5515d6EAd30D"
	DemoSrcKey   = ""
...
func TestTransferIntraChain(t *testing.T) {
	...
	dstAddr := "btp://0x228.snow/0x59d1d3450c1275ebf4ca477bf49fbcf910676e62"
	amt := new(big.Int)
	amt.SetString("500000000000000000", 10)
	for _, coin := range []string{"btp-0x228.snow-BNB"} {
...
func TestGetCoinBalance(t *testing.T) {
	...
	for _, coin := range []string{"btp-0x228.snow-BUSD", "btp-0x228.snow-USDT", "btp-0x228.snow-USDC", "btp-0x228.snow-BTCB", "btp-0x228.snow-ETH", "btp-0x2.icon-ICX", "btp-0x2.icon-sICX", "btp-0x2.icon-bnUSD", "btp-0x228.snow-ICZ"} {
...
func TestIsUserBlackListed(t *testing.T) {
	...
	res, err := rpi.IsUserBlackListed("0x228.snow", "0x94ACCD1f12cF6FF25Aaeb483605536918D7760b5")
	if err != nil {
		t.Fatal(err)
	}
	fmt.Println("Res ", res)

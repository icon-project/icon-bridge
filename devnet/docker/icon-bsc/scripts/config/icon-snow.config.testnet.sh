...
# testnet: begin
export TAG="ICON SNOW TESTNET"
export BSC_BMC_NET="0x229.snow"     # arctic
export BINANCE_BMC_NET="0x61.bsc"   # bsc
export ICON_BMC_NET="0x2.icon"      # icon
...
export ICON_WRAPPED_COIN_NAME=("btp-$BINANCE_BMC_NET-BNB" "btp-$BINANCE_BMC_NET-BUSD" "btp-$BINANCE_BMC_NET-USDT" "btp-$BINANCE_BMC_NET-USDC" "btp-$BINANCE_BMC_NET-BTCB" "btp-$BINANCE_BMC_NET-ETH" "btp-$BSC_BMC_NET-ICZ")
...
export BSC_WRAPPED_COIN_NAME=("btp-$BINANCE_BMC_NET-BNB" "btp-$BINANCE_BMC_NET-BUSD" "btp-$BINANCE_BMC_NET-USDT" "btp-$BINANCE_BMC_NET-USDC" "btp-$BINANCE_BMC_NET-BTCB" "btp-$BINANCE_BMC_NET-ETH" "btp-$ICON_BMC_NET-ICX" "btp-$ICON_BMC_NET-sICX" "btp-$ICON_BMC_NET-bnUSD")

...
COINNAMES=(btp-$ICON_BMC_NET-ICX btp-$ICON_BMC_NET-sICX btp-$ICON_BMC_NET-bnUSD \
            btp-$BSC_BMC_NET-BUSD btp-$BSC_BMC_NET-USDC btp-$BSC_BMC_NET-USDT \ 
            btp-$BSC_BMC_NET-BNB btp-$BSC_BMC_NET-ETH btp-$BSC_BMC_NET-BTCB)
TOKENLIMITS=(36500000000000000000000 30000000000000000000000 10000000000000000000000 \
            10000000000000000000000 10000000000000000000000 10000000000000000000000 \
            34000000000000000000 6000000000000000000 460000000000000000)

...
export ICON_WRAPPED_COIN_SYM=("ICZ" "DUM")
export ICON_WRAPPED_COIN_NAME=("btp-$BSC_BMC_NET-ICZ" "btp-$BSC_BMC_NET-DUM")
...
export ICON_WRAPPED_COIN_FIXED_FEE=(5000000000000000 1500000000000000000)
export ICON_WRAPPED_COIN_FEE_NUMERATOR=(100 100)
export ICON_WRAPPED_COIN_DECIMALS=(18 18)
...
export BSC_NATIVE_TOKEN_SYM=("DUM")
export BSC_NATIVE_TOKEN_NAME=("btp-$BSC_BMC_NET-DUM")
...
export BSC_NATIVE_TOKEN_FIXED_FEE=(1500000000000000000)
export BSC_NATIVE_TOKEN_FEE_NUMERATOR=(100)
export BSC_NATIVE_TOKEN_DECIMALS=(18)

...
public class TokenLimitRequest {
    private String[] coinName;
    private BigInteger[] tokenLimit;
    private String net;

    public TokenLimitRequest(){}

    public TokenLimitRequest(String[] coinName, BigInteger[] tokenLimit, String net) {
    ...
    public static TokenLimitRequest readObject(ObjectReader reader) {
        TokenLimitRequest obj = new TokenLimitRequest();
        reader.beginList();
    ...
    public static void writeObject(ObjectWriter writer, TokenLimitRequest obj) {
    ...
    public byte[] toBytes() {
        ...
        TokenLimitRequest.writeObject(writer, this);

...
public class TokenLimitResponse {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("TokenLimitResponse{");
    ...
    public static void writeObject(ObjectWriter writer, TokenLimitResponse obj) {
        obj.writeObject(writer);
    }

    public static TokenLimitResponse readObject(ObjectReader reader) {
        TokenLimitResponse obj = new TokenLimitResponse();
        reader.beginList();
    ...
    public static TokenLimitResponse fromBytes(byte[] bytes) {
        ObjectReader reader = Context.newByteArrayObjectReader("RLPn", bytes);
        return TokenLimitResponse.readObject(reader);
    }

    public byte[] toBytes() {
        ByteArrayObjectWriter writer = Context.newByteArrayObjectWriter("RLPn");
        TokenLimitResponse.writeObject(writer, this);
